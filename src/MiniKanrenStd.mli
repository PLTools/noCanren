...
module List :
  sig
    ...
    (** Relational foldr *)
    val foldro : (('a, 'b) injected -> ('acc, _ MiniKanren.logic as 'acc2) injected -> ('acc, 'acc2) injected -> goal) ->
    ...
    (** Relational lookup *)
    val lookupo : (('a, 'b) injected -> Bool.groundi -> goal) -> ('a, 'b) groundi -> ('a option, 'b option MiniKanren.logic) injected -> goal
    ...
    val membero : ('a, 'b MiniKanren.logic) groundi  -> ('a, 'b MiniKanren.logic) injected  -> goal
