type num = N1 | N2 | N3 | N4

type sudoku4X4 =
  S4x4 of num * num * num * num * num * num * num * num * num * num * num * num * num * num * num * num

let not_eq a b =
  match a with
  | N1 -> (match b with N1 -> false | N2 -> true  | N3 -> true  | N4 -> true )
  | N2 -> (match b with N1 -> true  | N2 -> false | N3 -> true  | N4 -> true )
  | N3 -> (match b with N1 -> true  | N2 -> true  | N3 -> false | N4 -> true )
  | N4 -> (match b with N1 -> true  | N2 -> true  | N3 -> true  | N4 -> false)
