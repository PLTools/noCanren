...
let _ =
  run1 ~n:1  (REPR (fun q     st -> addo !O !(S !O) q                     st) );
  (* run1 ~n:1  (REPR (fun q     st -> addo !(S !O) !(S !O) q                st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (addo !O !(S !O) q                     st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (addo !(S !O) !(S !O) q                st) ); *)
(*   run1 ~n:1    q  (fun q     st -> REPR (addo q !(S !O) !(S !O)                st) ); *)
(*   run1 ~n:1    q  (fun q     st -> REPR (addo !(S !O) q !(S !O)                st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (addo q !(S !O) !(S !O)                st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (addo !(S !O) q !(S !O)                st) ); *)
(*   run show_nat empty_reifier (-1)  qr  (fun q r   st -> REPR (addo q r !(S !(S !(S !(S !O))))       st), ["q", q; "r", r]); *)

(*   run1 ~n:1    q  (fun q     st -> REPR (mulo !O !(S !O) q                     st) ); *)
(*   run1 ~n:1    q  (fun q     st -> REPR (mulo !(S !(S !O)) !(S !(S !O)) q      st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (mulo !O !(S !O) q                     st) ); *)
(*   run1 ~n:1    q  (fun q     st -> REPR (mulo q !(S !(S !O)) !(S !(S !O))      st) ); *)
(*   run1 ~n:1    q  (fun q     st -> REPR (mulo q !(S !(S !O)) !(S !(S !(S !O))) st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (mulo q !(S !(S !O)) !(S !(S !O))      st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (mulo q !(S !(S !O)) !(S !(S !(S !O))) st) ); *)

(*   run1 ~n:1    q  (fun q     st -> REPR (mulo !(S !(S !O)) q !(S !(S !O))      st) ); *)
(*   run1 ~n:1    q  (fun q     st -> REPR (mulo !(S !(S !O)) q !(S !(S !(S !O))) st) ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (mulo !(S !(S !O)) q !(S !(S !O)) st)      ); *)
(*   run1 ~n:2    q  (fun q     st -> REPR (mulo !(S !(S !O)) q !(S !(S !(S !O))) st) ); *)
...
(*   run1 ~n:1    q  (fun q     st -> REPR (mulo !(S !O) !(S !O) q                st) ); *)
