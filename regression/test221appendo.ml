...
let _ =
  run show_int_list    (-1) q   ("appendo", (fun q     -> prog id_set1 [appendo ]     (invoke "appendo"   (inj_list [1; 2] ^~ inj_list [3; 4]  ^. q))           )) qh;
  run show_int_list    (-1) q   ("appendo", (fun q     -> prog id_set1 [appendo ]     (invoke "appendo"   (q ^~ inj_list [3; 4]  ^. inj_list [1; 2; 3; 4]))     )) qh;
  run show_int_list    (-1) q   ("appendo", (fun q     -> prog id_set1 [appendo ]     (invoke "appendo"   (inj_list [1; 2] ^~ q  ^. inj_list [1; 2; 3; 4]))     )) qh;
  run show_int_list    (-1) qr  ("appendo", (fun q r   -> prog id_set1 [appendo ]     (invoke "appendo"   (q ^~ r  ^. inj_list [1; 2; 3; 4]))                   )) qrh;
  run show_int_list    (-1) q   ("reverso", (fun q     -> prog id_set1 reverso_list   (invoke "reverso"   (q ^. inj_list (nat_pref 70)))                      )) qh;
  run show_int_list    (-1) q   ("reverso", (fun q     -> prog id_set1 reverso_list   (invoke "reverso"   (inj_list [1; 2; 3; 4; 5] ^. q))                      )) qh;
  run show_int_list    (-1) q   ("reverso", (fun q     -> prog id_set1 reverso_list   (invoke "reverso"   (inj_list [1; 2; 3] ^. inj_list [3; 2; 1]))           )) qh;
  run show_int_list    (-1) q   ("reverso", (fun q     -> prog id_set1 reverso_list   (invoke "reverso"   (inj_list [1; 2; 1] ^. inj_list [3; 2; 1]))           )) qh;
