...
######################## Tests related stuff  ##########################
REGRES_CASES := 000 002sort 001 004 005 006 007 009 010 011 013 014 015runaway 016sorto 017tabling 018prjc 019tablingCache 020 021_fair_conj 022_einstein 023_bridge 024_lorry
